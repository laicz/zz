...
/**
 * 离职实现放值和取值，租后代码提供全部命令实现
 * 
 * @author Mr.Zhou
 * @datatime 2018年4月22日下午9:21:59
 */
...
public class RedisClientTemplate {
	...
	public String set(String key, String value) {
		...
		try {
			...
			redisDataSource.returnResource(shardedJedis, broken);// 关闭链接资源
		}
		return result;
	}
	...
	/**
	 * 在设置的时间后自动删除（在Redis中设置时间后删除的key被认为是不稳定的）
	 * 
	 * @param key
	 * @param unixTime
	 * @return
